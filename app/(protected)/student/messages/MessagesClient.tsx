...
export default function MessagesClient({
  ...
  // Scroll to bottom of thread when conversation changes or new messages arrive
  useEffect(() => {
  ...
  const groups = activeConversation
    ? groupByDate(activeConversation.messages)
    : []
    ...
    <div className="flex flex-col h-full" style={{ minHeight: 0 }}>
      ...
      >
        ...
        <span className="leading-relaxed">
          <strong>Güvenlik Uyarısı:</strong> Platform dışı iletişim bilgisi paylaşmak
          yasaktır. Telefon numarası, e-posta veya sosyal medya adresi içeren mesajlar
      ...
      {conversations.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center gap-3 p-8">
          ...
          <p className="text-sm text-center" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            <br />
            Öğretmeniniz size mesaj gönderdiğinde burada görünecek.
          </p>
        </div>
      ) : (
              ...
              >
                {warning && (
                  ...
                  >
                    ...
                    <span>
                      Uyarı: {warning}. Göndermeniz durumunda bu mesaj işaretlenecektir.
                    </span>
                  </div>
                )}
                <form
